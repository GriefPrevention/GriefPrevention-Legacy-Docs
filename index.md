...
GriefPrevention Legacy is a Bukkit plugin, and therefore is compatible with the following Minecraft **server** modifications:
- Purpur
- Spigot
- Paper
- CraftBukkit
...
<!-- TODO: Remove these sections (sans download link) when v20 is official-->
